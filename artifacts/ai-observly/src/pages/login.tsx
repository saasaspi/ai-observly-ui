  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center p-6 bg-background">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="founder@startup.com" {...field} data-testid="input-email" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <p className="mt-8 text-muted-foreground text-sm">
        Don't have an account? <Link href="/signup" className="text-primary hover:underline font-medium" data-testid="link-signup">Sign up</Link>
      </p>
    </div>
  );
}
